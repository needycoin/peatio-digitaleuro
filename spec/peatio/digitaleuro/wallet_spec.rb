RSpec.describe Peatio::Digitaleuro::Wallet do
  let(:wallet) { Peatio::Digitaleuro::Wallet.new }
  ...
  context :configure do
    let(:unconfigured_wallet) { Peatio::Digitaleuro::Wallet.new }
    ...
    it 'sets settings attribute' do
      ...
      expect(unconfigured_wallet.settings).to eq(settings.slice(*Peatio::Digitaleuro::Wallet::SUPPORTED_SETTINGS))
    end
  end
